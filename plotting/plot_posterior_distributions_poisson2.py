...
tikz_save('../report/fig/ic_poisson2_mcmc_predmean.tikz',
...
tikz_save('../report/fig/ic_poisson2_mcmc_base.tikz',
          figureheight='\\figureheight',
          figurewidth='\\figurewidth')
...
plot_param_hist(lscale_local_mcmc, '$\\rho_\mathrm{(l)}$',
                ...
                filename='../report/fig/ic_poisson2_mcmc_lscale_local.tikz')

plot_param_hist(lscale_base_mcmc, '$\\rho_\mathrm{(b)}$',
                lambda x: 2 * (1/0.25) * stats.t.pdf(x/0.25, 2),
                filename='../report/fig/ic_poisson2_mcmc_lscale_base.tikz')

plot_param_hist(s_local_mcmc, '$\sigma_\mathrm{(l)}$',
                lambda x: 2 * stats.t.pdf(x, 2),
                filename='../report/fig/ic_poisson2_mcmc_s_local.tikz')

plot_param_hist(s_base_mcmc, '$\sigma_\mathrm{(b)}$',
                lambda x: 2 * stats.t.pdf(x, 2),
                filename='../report/fig/ic_poisson2_mcmc_s_base.tikz')
